...
/**
 * @typedef {200|201|204|400|401|403|404|409|500} HttpStatusCodeNumber
 */
 ...
 * @property {HttpStatusCodeNumber} HTTP_404_NOT_FOUND - HTTP 404 Not Found
 * @property {HttpStatusCodeNumber} HTTP_409_CONFLICT - HTTP 409 Conflict
 * @property {HttpStatusCodeNumber} HTTP_500_SERVER_ERROR - HTTP 500 Server Error
 */
